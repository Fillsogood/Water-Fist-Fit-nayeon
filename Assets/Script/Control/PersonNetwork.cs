...
public class PersonNetwork : MonoBehaviour
{
    PersonCamera cameraScript;
    PersonControl controllerScript;
    private bool appliedInitialUpdate;
    PhotonView photonView;

    void Awake()
    {
        cameraScript = GetComponent<PersonCamera>();
        controllerScript = GetComponent<PersonControl>();
    ...
    void Start()
    {
        ...
        controllerScript.SetIsRemotePlayer(!photonView.IsMine); //false
